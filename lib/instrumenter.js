...
(function (isNode) {
    ...
    Instrumenter.prototype = {
        ...
        filterHintsAndExtractSourceMap: function (comments) {
            ...
            for (i = 0; i < comments.length; i += 1) {
                ...
                if (comment && comment.value) {
                    ...
                    if (mapMatch) {
                        this.originSourceMapUrl = mapMatch[1];
                    }
                }
            }
            return ret;
        ...
        /**
         * returns any source mapping URL that was found for the last file
         * instrumented
         * @method lastOriginSourceMapUrl
         * @return {String} a source map URL or null
         */
        lastOriginSourceMapUrl: function () {
            return this.originSourceMapUrl;
        },
